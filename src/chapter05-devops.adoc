...
Le *Cross-site Scripting* consiste à envoyer un formulaire d’un site vers un autre. Ainsi, un formulaire d'un site A pourrait demander une action sur un site B en profitant que sur l'utilisateur est déjà connecté ur le site B.
