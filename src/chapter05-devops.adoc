...
Etant dans une startup, mon travail ne s'est pas cantonné à du developpement logiciel mais aussi à l'administration d'un serveur Linux. Dans cette section je vais retracer les actions que j'ai effectué afin d'installer et de sécuriser mon serveur.
