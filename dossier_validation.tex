...
\chapter{Préface}
  ...
  \section{licence}
    ...
    Tout le code source de ce document (rédigé en \LaTeX) est disponnible sur le repertoire Git suivant: \url{http://git.rousseau-alexandre.fr/madeindjs/it_report}.
...
\chapter{Présentation du projet}
  ...
  \section{Statut juridique}\label{sec:sas}
    ...
    Pour en savoir plus sur ce régime, je vous invite à consulter \href{https://www.lecoindesentrepreneurs.fr/pourquoi-creer-une-sasu/}{cet article}
